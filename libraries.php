...
function axg_assets_loader() {
  $source = "https://api.axoncodes.com/libraries";
  ...
  wp_register_script("axg_activationHandler_script",  "$source/activationHandler",          '', array(), true); wp_enqueue_script('axg_activationHandler_script');
